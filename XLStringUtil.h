...
public:
	...
	static const char* strchrV(std::string& target, char n1 ,char n2 = 0,char n3 = 0,char n4 = 0,char n5= 0,char n6 = 0,char n7 = 0 );
	static const char* strchrV(const char*  target, char n1 ,char n2 = 0,char n3 = 0,char n4 = 0,char n5= 0,char n6 = 0,char n7 = 0 );
	static const char* notnull_min(const char* n1=NULL,const char* n2=NULL,const char* n3=NULL,const char* n4=NULL,const char* n5=NULL,const char* n6=NULL,const char* n7=NULL);
	...
	static std::string mb_convert_encoding(const std::wstring& str, const std::string& to, const std::string& from = "");
	...
	static std::string ByteToHumanReadable(const size_t & size);
